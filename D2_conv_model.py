...
# 일단은 tensorlayer를 이용하여 Model을 구성해보자!!!!!
# tensorflow 2.0 layer와 tensorlayer 2.0의 layer는 서로 호환할 수 없는것같다.(실험을 따로 진행해보았음)
...
#    for _ in range(n_downsamplings):
#        dim //= 2
#        h = tl.layers.DeConv2dLayer(dim, (3,3), strides=(2,2), act=tf.nn.relu, padding='SAME', b_init=None)(h)   # 여기서부터 다시 시작해야한다.
#        h = tl.layers.InstanceNorm2d()(h)
